  ...
  soal: [
    {
      ...
      pembahasan: 'Muhammad bin Musa Al-Khwarizmi adalah matematikawan Persia yang bukunya menjadi asal-usul kata "Algoritma" yang diambil dari pelafalan Latin namanya, Algoritmi.'
    },
    {
      ...
      pembahasan: 'Algoritma adalah konsep abstrak tentang urutan, urutan langkah-langkah logis dan sistematis untuk menyelesaikan masalah. Pilihan A, C, D, dan E lebih merujuk pada komponen fisik seperti data/hardware maupun hasil dari program, bukan definisi algoritma itu sendiri.'
    },
    {
      ...
      pembahasan: 'Flowchart menggunakan simbol grafis standar seperti oval, persegi, belah ketupat untuk merepresentasikan aliran instruksi. Sementara Pseudocode dan pilihan lainnya berbentuk teks, bukan grafis.'
    },
    {
      ...
      pembahasan: 'Syarat utama algoritma adalah langkahnya harus logis dan dapat diikuti oleh manusia atau komputer. Algoritma tidak harus dalam bahasa Inggris dan bisa bahasa Indonesia, tidak harus di Windows, dan tidak butuh visual menarik. Inti dari algoritma adalah logika pemecahan masalah.'
    },
    {
      ...
      pembahasan: 'Rumus fundamental ini dipopulerkan oleh Niklaus Wirth, seorang ilmuwan komputer yang menjelaskan bahwa sebuah perangkat lunak yang utuh dan berfungsi bukanlah sekadar kumpulan kode (program), melainkan kombinasi harmonis antara langkah-langkah pemecahan masalah (algoritma) dengan cara data tersebut disusun dan disimpan (struktur data).'
    },
    {
      ...
      pembahasan: 'Niklaus Wirth adalah ilmuwan komputer yang merumuskan persamaan Program = Algorithm + Data Structures sesuai dengan fakta sejarah dalam ilmu komputer.'
    },
    {
      ...
      pembahasan: 'Algoritma bersifat hardware-independent atau bebas perangkat keras yang merujuk pada program, sistem, atau teknologi yang tidak terikat pada jenis perangkat keras fisik tertentu. Ilmu algoritma fokus pada efisiensi logika, bukan pada biaya atau merk perangkat keras yang digunakan.'
    },
    {
      ...
      pembahasan: 'Finiteness (keterbatasan) menjamin algoritma akan berhenti setelah langkah tertentu. Jika tidak, ia akan infinite loop / tidak pernah berhenti, yang merupakan kegagalan algoritma.'
    },
    {
      ...
      pembahasan: 'Definiteness adalah kepastian. Langkah-langkah tidak boleh memiliki dua arti dan ambigu. Komputer harus tahu persis apa yang harus dilakukan di setiap baris.'
    },
    {
      ...
      pembahasan: 'Effectiveness berarti instruksi dapat dilakukan. Jika instruksi mustahil dikerjakan atau membutuhkan waktu/memakan waktu, maka itu tidak efektif.'
    },
    {
      ...
      pembahasan: 'Resep adalah algoritma karena ada input (bahan), ada proses (memotong, memasak), dan ada output (makanan jadi). Sementara kegiatan lain di pilihan A, C, D, E tidak memiliki urutan proses logis.'
    },
    {
      ...
      pembahasan: 'Jika algoritma benar, Maka bisa menerjemahkannya ke C++, Java, atau Python. Jadi, ia tidak bergantung pada bahasa tertentu.'
    },
    {
      ...
      pembahasan: 'Siklus dasar komputer adalah menerima Input, mengolahnya (Proses), dan menampilkan Output. Hal tersebut adalah alur dasar pengolahan data (Information Processing Cycle).'
    },
    {
      ...
      pembahasan: 'Algoritma adalah konsep (abstrak), sedangkan mekanisme adalah bentuk nyata atau fisik dari ide tersebut (misal: mesin).'
    },
    {
      ...
      pembahasan: 'Menulis kode langsung tanpa algoritma sering menyebabkan logical error atau program berjalan tapi hasilnya salah. Algoritma berfungsi sebagai ‘cetak biru’ untuk memastikan logika benar sebelum diketik.'
    },
    {
      ...
      jawabanBenar: 'Coding',
      pembahasan: 'Setelah desain algoritma dibuat, tahap berikutnya adalah menuliskan desain tersebut ke dalam bahasa pemrograman atau yang disebut coding.'
    },
    {
      ...
      pembahasan: 'Algoritma yang efisien adalah yang paling hemat dalam penggunaan sumber daya komputer.'
    },
    {
      ...
      pembahasan: 'Jika algoritma bergantung pada satu bahasa, maka ia tidak fleksibel. Dengan bersifat independen, ia bisa diterapkan ke banyak bahasa pemrograman.'
    },
    {
      ...
      pembahasan: 'Cara mengekspresikan algoritma standar adalah Bahasa Natural, Pseudocode, dan Flowchart yang nantinya menjadi bahasa pemrograman. Sementara, video tutorial adalah media belajar, bukan notasi algoritma.'
    },
    {
      ...
      pembahasan: 'Logika yang benar memastikan bahwa untuk input tertentu, komputer selalu menghasilkan output yang benar dan konsisten.'
    }
  ]
}
];